...
html5namapv4.503 - trial version
...
! function(e) {
    var t, o, r, n = {};
    (function() {
        var e, t, o, r, n, s, a, l, c, p, m, u = this || Function("return this")(),
            d = function() {
                "use strict";
                var e, t, o, r, n, s = "linear",
                    a = Date.now || function() {
                        return +new Date
                    },
        ...
        function $(e, t, o) {
            var r = t.match(e),
                n = t.replace(e, c);
            if (r)
                for (var s, a = r.length, l = 0; l < a; l++) s = r.shift(), n = n.replace(c, o(s));
            return n
        }
            ...
            beforeTween: function(e, o, r, n) {
                ...
                s = n, a = this._tokenData, t.each(a, function(e) {
                    var t = a[e].chunkNames,
                        ...
                        r = s[e];
                    if ("string" == typeof r)
                        for (var n = r.split(" "), l = n[n.length - 1], c = 0; c < o; c++) s[t[c]] = n[c] || l;
                    else
                        for (c = 0; c < o; c++) s[t[c]] = r;
                    delete s[e]
    ...
    var s = function() {
            ...
            return {
                ...
                findPos: function e(t) {
                    ...
                    for (var s = r = 0, a = t, l = !1;
                        (a = a.parentNode) && a != document.body;) s -= a.scrollLeft || 0, r -= a.scrollTop || 0, "fixed" == o(a, "position") && (l = !0);
                    if (l && !window.opera) {
                        var c, p = (c = document.getElementsByTagName("html")[0], c.scrollTop && document.documentElement.scrollTop ? [c.scrollLeft, c.scrollTop] : c.scrollTop || document.documentElement.scrollTop ? [c.scrollLeft + document.documentElement.scrollLeft, c.scrollTop + document.documentElement.scrollTop] : document.body.scrollTop ? [document.body.scrollLeft, document.body.scrollTop] : [0, 0]);
                        s += p[0], r += p[1]
                    }
                    do s += t.offsetLeft, r += t.offsetTop; while (t = t.offsetParent);
    ...
    function h() {
        ...
        function tq() {
            te = t4.locations, eZ = [], eU = [], eK = [], e9 = [], eG = [], ti = [], ! function() {
                    var e = {};
                    if (e.color = !1, e.hover_color = !1, e.opacity = a.region_opacity ? a.region_opacity : 1, e.hover_opacity = a.region_hover_opacity ? a.region_hover_opacity : .6, e.url = !1, e.description = !1, e.description_mobile = !1, e.inactive = !1, e.zoomable = !0, e.hide_name = "yes" == a.region_hide_name, e.popup = a.region_popups ? a.region_popups : eu, e.cascade = "yes" == a.region_cascade_all, e.zoom_percentage = M, e.x = !1, e.y = !1, e.x2 = !1, e.y2 = !1, P)
                        for (var t in P)
                            for (var o = 0; o < P[t].states.length; o++) eK[P[t].states[o]] = t;
                    for (var r in P)
                        for (var n in eG[r] = Object.create(e), P[r].url && (eG[r].zoomable = !1), P[r]) "default" != P[r][n] && (eG[r][n] = P[r][n]), "yes" == P[r][n] && (eG[r][n] = !0), "no" == P[r][n] && (eG[r][n] = !1)
                }(),
                function() {
                ...
                function() {
                    var e = {},
                        t = em ? a.scale_limit_mobile ? a.scale_limit_mobile : .4 : .0625;
                    e.scale_limit = a.scale_limit ? a.scale_limit : t, e.geojson_url = !!a.location_geojson_url && a.location_geojson_url, e.geojson_field = a.location_geojson_field ? a.location_geojson_field : "id", e.geojson_value = !!a.location_geojson_value && a.location_geojson_value, e.hover_color = !!a.location_hover_color && a.location_hover_color, e.border = a.location_border ? a.location_border : 1.5, e.border_color = a.location_border_color ? a.location_border_color : "#FFFFFF", e.hover_border = a.location_hover_border ? a.location_hover_border : 2, e.size = a.location_size, e.description = a.location_description, e.description_mobile = !!a.location_description_mobile && location_description_mobile, e.url = a.location_url, e.inactive = "yes" == a.all_locations_inactive, e.type = a.location_type, e.position = "top", e.level = 5, e.pulse = "yes" == a.location_pulse, e.pulse_size = a.location_pulse_size ? a.location_pulse_size : 4, e.pulse_speed = a.location_pulse_speed ? a.location_pulse_speed : .5;
                    var o = a.location_pulse_color;
                    for (var r in e.pulse_color = !!o && "auto" != o && o, e.image_source = a.location_image_source ? a.location_image_source : "", e.hide = a.all_locations_hide ? a.all_locations_hide : "no", e.opacity = G, e.scale = !a.location_scale || a.location_scale, e.hover_opacity = !!a.location_hover_opacity && a.location_hover_opacity, e.image_source = a.location_image_source ? a.location_image_source : "", e.image_url = !!a.location_image_url && a.location_image_url, e.image_position = a.location_image_position ? a.location_image_position : "center", e.image_hover_source = a.location_image_hover_source ? a.location_image_hover_source : "", e.image_hover_url = !!a.location_image_hover_url && a.location_image_hover_url, e.image_hover_position = a.location_image_hover_position ? a.location_image_hover_position : "center", e.popup = a.location_popups ? a.location_popups : eu, e.x = !1, e.y = !1, e.link_text = D, e.display = a.location_display ? a.location_display : "all", e.display_ids = !1, e.hide = "yes" == a.all_locations_hidden, e.hide_name = "yes" == a.location_hide_name, void 0 == e.type, te) {
                ...
                function() {
                    ...
                    for (var o in t)
                        for (var r in ti[o] = Object.create(e), t[o]) "default" != t[o][r] && (ti[o][r] = t[o][r]), "yes" == t[o][r] && (ti[o][r] = !0), "no" == t[o][r] && (ti[o][r] = !1)
                }()
        }
        var tH = !1,
            tV = !1,
        ...
        function tZ(e, t) {
            if ("lambert" == t2.proj) var o = function e(t) {
                var o = Math.PI,
                    r = .017453293 * t.lat,
                    n = .017453293 * t.lng,
                    s = Math.log(.8386705593173225 * (1 / .7071067659112366)) / Math.log(Math.tan(.25 * o + .3926990925) * (1 / Math.tan(.25 * o + .2879793345))),
                    a = .8386705593173225 * Math.pow(Math.tan(.25 * o + .2879793345), s) / s,
                    l = a * Math.pow(1 / Math.tan(.25 * o + .5 * r), s);
                return {
            ...
            function n(e) {
                var t, o, r = 5,
                    ...
                    d = m / 5,
                    f = (c - p) / 5,
                    h = [.8487, .84751182, .84479598, .840213, .83359314, .8257851, .814752, .80006949, .78216192, .76060494, .73658673, .7086645, .67777182, .64475739, .60987582, .57134484, .52729731, .48562614, .45167814],
                    y = [0, .0838426, .1676852, .2515278, .3353704, .419213, .5030556, .5868982, .67182264, .75336633, .83518048, .91537187, .99339958, 1.06872269, 1.14066505, 1.20841528, 1.27035062, 1.31998003, 1.3523];
                return {
            ...
            function l(e, t, r, n) {
                var a, l, c, p, m, u, d, f, h, y, $, v, _, g, b, x, w, k = o(e),
                    z = o(t),
                    P = o(r),
                    E = o(n),
                    A = s.distance(k, z),
                    ...
                    j = s.distance(t, r),
                    B = S / j,
                    T = (a = t.x, l = t.y, c = A / B, p = r.x, m = r.y, u = C / B, f = p - a, y = Math.sqrt((h = m - l) * h + f * f), g = a + f * (d = (c * c - u * u + y * y) / (2 * y)) / y, b = l + h * d / y, v = -h * (($ = Math.sqrt(c * c - d * d)) / y), _ = f * ($ / y), x = g + v, {
                        opt1: {
                            x: x,
                            y: w = b + _
                        },
        ...
        function tG(e) {
            ...
            var t, o = s.rotate_bbox(e.sm.bbox, eC),
                r = o.x,
                n = o.y,
                a = o.width,
                l = o.height,
        ...
        function or(e, t) {
            ...
            tD(), o = e, r = t, eL.hide(), eL.forEach(function(e) {
                ...
                }(e, t), s.x_in_array(n, ["state", "region", "out"]) && oe(), "region" == n ? tJ(e) : "state" == n ? tJ(tm[e.sm.region]) : "manual" == n && eO.forEach(function(e) {
        ...
        function op(e) {
            tC("viewbox_updated", [e]), ol && ol.fitBounds(oc(e), {
                animate: !1
            })
        }
        ...
        function o8(e) {
            ...
            var a = e.sm.url ? e.sm.url : "",
                ...
                p = s.replaceAll(l, "'", '"'),
                m = U ? 'return (function(e){window.open("' + a + '","_blank"); return false})()' : c ? 'return (function(){window.location.href="' + a + '"; return false;})()' : 'return (function(){window.top.location.href="' + a + '"; return false;})()';
            c && (m = "(function(){" + p + "})()");
        ...
        function o0() {
            for (var e in s.clear_sets([eD, e4, eI]), td = {}, ty = {}, tf = {}, e9 = e9.reverse(), th = function(e) {
                    var t = e9[e],
                        o = !1,
                        r = !1;
                    if (e9.hasOwnProperty(e)) {
                        ...
                        if ("state" == t.parent_type ? u = tp[t.parent_id] : "region" == t.parent_type ? u = tm[t.parent_id] : "location" == t.parent_type && (u = t$[t.parent_id]), !t.x && !t.y && u) {
                            if ("location" == u.sm.type) r = !0, m.x = u.sm.x, m.y = u.sm.y, p = u.sm.point0, o = !0, u.sm.auto_size && (d = !0);
                                ...
                                var f = u.sm.bbox;
                                if (f.cx && f.cy) var h = S,
                                    y = j;
                                else var h = (f.x + f.x2) / 2,
                                    y = (f.y + f.y2) / 2;
                        ...
                        if (u.sm.inactive && (_.cursor = "default"), v.attr(_), v.sm.attributes = _, v.sm.over_attributes = g, v.sm.out_attributes = b, v.sm.type = "label", v.sm.id = e, v.sm.scale = o || t.scale, v.sm.scale_limit = t.scale_limit, v.sm.x = m.x, v.sm.y = m.y, v.sm.level = s.to_float(u.sm.level) + .1, v.sm.point0 = p, v.sm.line_x = t.line_x, v.sm.line_y = t.line_y, v.sm.line = !1, v.sm.rotate = t.rotate, v.transform(ox(v, e3)), t.display ? v.sm.display = t.display : "region" == t.parent_type ? v.sm.display = "out" : "location" == t.parent_type ? v.sm.display = u.sm.display : v.sm.display = a.labels_display ? a.labels_display : "all", v.sm.display_ids = !!t.display_ids && t.display_ids, (t.line || t.pill || d) && (v.sm.bbox = og(v)), "auto" == t.display && "state" == t.parent_type) {
                            ...
                            var x = [.99, .501, .251, .1251, .06251, .031251, .0156255, .00781275],
                                w = t2.paths[u.sm.id],
                                k = u.sm.bbox;
                            for (var z in x) {
                                var P = x[z],
        ...
        function ow(e) {
            ...
            for (var t in s.clear_sets([eL]), t$ = {}, tv = function(e) {
                    var t = "center",
                        n = eU[e];
                    ...
                    set_pos: function(e, t, o) {
                        if (q) {
                            if (!(o && o.sm.on_click && ("yes" == F || "auto" == F && eb < 401)) && e && t) {
                                ...
                                var n = eb - (Z = parseInt(q.offsetWidth, 10)) > 0 ? .5 * (eb - Z) : 0,
                                    s = ex - H > 0 ? .5 * (ex - H) : 0;
                            ...
                            function p(e, t) {
                                if (void 0 === t && (t = "z"), k && "region" != k.sm.type) t3.call(k, !0, function() {
                                    ...
                                    var r = function e(t, o) {
                                        ...
                                        else var r = tu.sm.zooming_dimensions.w / t,
